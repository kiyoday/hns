<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\xampp\htdocs\hns\public/../application/index\view\order\index.html";i:1525884744;s:69:"D:\xampp\htdocs\hns\public/../application/index\view\public\head.html";i:1525883365;s:71:"D:\xampp\htdocs\hns\public/../application/index\view\public\header.html";i:1525915440;s:71:"D:\xampp\htdocs\hns\public/../application/index\view\public\footer.html";i:1525881415;}*/ ?>
<!doctype html>
            ...
            <tbody>
                ...
                <tr class="j-row">
                    <td class="vtop">
                        ...
                        <div class="img-wrap">
                        <a href="<?php echo url('order/orderinfo',['bid'=>$vo['bookid']]); ?>" target="_blank"><img src="<?php echo $vo['photo']; ?>" style="height:70px;width:80px;"></a>
                        </div>
                        <div class="title-wrap">
                        <div class="title">
                        <a href="<?php echo url('view/index',['bid'=>$vo['bookid']]); ?>" class="link"><?php echo $vo['name']; ?></a>
                        </div>
                        <div class="attrs"></div>
                        </div>
                        </div>
                    ...
                    <td class="price font14" ><span class="j-sumPrice" style=""><?php echo $vo['order_id']; ?></span></td>
                    <td class="price font14" ><span class="j-sumPrice" style=""><?php echo $vo['expnum']; ?></span></td>
                    ...
                    <?php if($vo['expnum'] == 0): ?>
                    <!--<a href="<?php echo url('buy/index',['bid'=>$vo['order_id']]); ?>" title="结算" class="colors-btn" style="colot:gray;cursor:pointer;pointer-events:none;">确认收货</a>-->
                    <?php else: if($vo['orderstatus'] == '1'): ?>
                    <a href="<?php echo url('order/goodsConfirm',['bid'=>$vo['bookid']]); ?>" title="结算" class="colors-btn" >确认收货</a>
