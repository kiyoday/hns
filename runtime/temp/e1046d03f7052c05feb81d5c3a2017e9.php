<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\xampp\htdocs\hns\public/../application/index\view\center\changepwd.html";i:1525710297;s:69:"D:\xampp\htdocs\hns\public/../application/index\view\public\head.html";i:1525696765;s:71:"D:\xampp\htdocs\hns\public/../application/index\view\public\header.html";i:1525877626;s:71:"D:\xampp\htdocs\hns\public/../application/index\view\public\footer.html";i:1525881415;}*/ ?>
<!doctype html>
        ...
        <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <section class="content-wrapper">
                	<div class="content-container container">                        
                        ...
                        <form action="<?php echo url('center/change'); ?>" method="post">
                		<div  class="col-main">
                			<h1 class="page-title">更改密码</h1>
                			<div class="contact-form-container">
                				<div  class="form-title">请填写旧密码</div>
                				<ul class="form-fields">
                					<li class="left">
                						<label>您的旧密码<em>*</em></label>
                						<input id="opwd" name="opwd" type="text" value=""></br>
                					</li>
                                    ...
                                    <div class="clearfix"></div>
                                    <li class="left">
                                        <label>再次输入密码<em>*</em></label>
                                        <input id="gpwd" name="gpwd" type="text" >
                                    </li>
                                    <div class="clearfix"></div>
                				</ul>
                				<div class="button-set">
                					<button type="submit" class="form-button"><span>更改</span></button>
                				</div>
                			</div>
                		</div>
                        </form>
