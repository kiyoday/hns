<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\xampp\htdocs\hns\public/../application/index\view\booksell\delivery.html";i:1525623947;s:69:"D:\xampp\htdocs\hns\public/../application/index\view\public\head.html";i:1525883365;s:71:"D:\xampp\htdocs\hns\public/../application/index\view\public\header.html";i:1525915440;s:71:"D:\xampp\htdocs\hns\public/../application/index\view\public\footer.html";i:1525881415;}*/ ?>
<!doctype html>
        ...
        <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <!--Content Block-->
                 <section class="content-wrapper">
                  <form method="post" action="<?php echo url('booksell/save',['bid'=>$book['book_id']]); ?>">
                 
                  <table class="table table-goods" cellpadding="0" cellspacing="0">
                <tbody>
                <tr>
                    <th width="130" class="first">收货人姓名</th>
                    <th width="140">联系电话</th>
                    <th width="140">收获地址</th>
                    <th width="140">快递单号</th>
                    
                </tr>
                <tr class="j-row">
                      <td class="font14" align="center"><span><?php echo $buyer['name']; ?></span></td>
                      <td class="price font14" align="center" style="color:#35C2D8;"><span class="j-sumPrice" ><?php echo $buyer['address']; ?></span></td>
                      <td class="font14" align="center"><span><?php echo $buyer['address']; ?></span></td>
					<td class="font14" align="center"><input type="text" name="expnum"></td>
                </tr>
                </tbody>
              </table>
             ...
             <div class="firstly">
              <table class="table table-goods" cellpadding="0" cellspacing="0">
                ...
                <tr class="j-row">
                    <td class="">
                        <div class="title-area" title="<?php echo $book['name']; ?>">
                        <div class="">
                        <a href="" target="_blank"><img src="<?php echo $book['photo']; ?>" style="height:100px;width:100px;"></a>
                        </div>
						</div>
                    </td>
                      <td class="font14" align="center"><span><?php echo $book['name']; ?></span></td>
                      <td class="price font14" align="center" style="color:#35C2D8;"><span class="j-sumPrice" >￥<?php echo $book['price']; ?></span></td>
                      <td class="font14" align="center"><span><?php echo $seller['name']; ?></span></td>
                      <td class="font14" align="center"><span><?php echo $seller['phone']; ?></span></td>
                </tr>
                </tbody>
              </table>
				 </form>
              <div class="final-price-area" style="text-align:right">结算金额：<span class="sum" style="color:#35C2D8;">￥<span class="price" style="color:#35C2D8;"><?php echo $book['price']; ?></span></span></div>
              <div class="page-button-wrap" style="text-align:right;color:#35C2D8;" >
              <button type="submit" class="btn btn-primary" style="background:#35C2D8;">确认发货</button>
              </div>
