<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\xampp\htdocs\hns\public/../application/admin\view\user\index.html";i:1525841402;s:71:"D:\xampp\htdocs\hns\public/../application/admin\view\public\header.html";i:1523271222;s:71:"D:\xampp\htdocs\hns\public/../application/admin\view\public\footer.html";i:1523271222;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="text-l"><?php echo $vo['credit']; ?></td>
				<td><?php echo $vo['address']; ?></td>
				<!--<td class="td-status"><span class="label label-success radius">已启用</span></td>-->
				
				<td class="td-status"><a href="<?php echo url('user/status',['id'=>$vo['id'],'status'=>$vo['status']==1?0:1]); ?>" title="点击以改用户是否被禁用">
					<?php if($vo['status'] == '0'): ?>
					<span class="label label-success radius">正常</span>
					<?php else: ?>
					<span class="label  label-danger radius" >被禁用</span>
					<?php endif; ?>
		        </a></td>
