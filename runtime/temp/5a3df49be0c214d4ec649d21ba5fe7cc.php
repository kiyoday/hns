        ...
        <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <!--Content Block-->
                 <section class="content-wrapper">
                  <form method="post" action="<?php echo url('order/orderinfo',['bid'=>$bid['book_id']]); ?>">
                  ...
                  <div class="content-container container"> 
                   <h1 class="page-title"><font color="#35C2D8">订单其他信息</font></h1>
