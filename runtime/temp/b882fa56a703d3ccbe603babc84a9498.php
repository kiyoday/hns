<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"C:\xampp\htdocs\hns\public/../application/index\view\search1\index.html";i:1525689809;s:69:"C:\xampp\htdocs\hns\public/../application/index\view\public\head.html";i:1525346003;s:71:"C:\xampp\htdocs\hns\public/../application/index\view\public\footer.html";i:1523271222;}*/ ?>
<!doctype html>
...
<body>
  ...
  <header class="container">
    ...
    <nav id="smoothmenu1" class="ddsmoothmenu mainMenu">
      <ul id="nav">
        <li class=""><a href="<?php echo url('index/index'); ?>" title="Home">首页</a></li>
        <?php if(is_array($categorys) || $categorys instanceof \think\Collection || $categorys instanceof \think\Paginator): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <li class="" id="categorys"><a href="<?php echo url('Search1/index',['type'=>$vo['type_name']]); ?>" title="<?php echo $vo['type_name']; ?>"><?php echo $vo['type_name']; ?></a></li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </nav> 
  </header>
            ...
            <section class="banner-wrapper">
              <div class="banner-block container">
                ...
                <ul class="banner-add">
                  ...
                  <li class="add2"><a href="#" title=""><img title="add2" alt="add1" src="__STATIC__/index/images/2.jpg" /></a></li>
                </ul>
              </div>
            </section>
            <!--Content Block-->
              ...
              <div class="content-container container">
                ...
                <div class="feature-block">
                  <ul id="mix" class="product-grid">
      				      <li>
                      <div class="pro-img"><img title="Freature Product" alt="Freature Product" src="__STATIC__/index/images/default_img(2).png" /></div>
                      <div class="pro-hover-block">
                        ...
                        <a href="<?php echo url('view/index',['bid'=>22]); ?>" class="quickproLink" title="Link">Product link</a></div>
    ...
    <!--Quick view Block  window.onload = function(){-->    
           <!--Footer Block-->  
            <!--Footer Block-->
